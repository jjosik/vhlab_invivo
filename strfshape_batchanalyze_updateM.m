function [  ] = strfshape_batchanalyze_updateM( pixels_square,varargin )
...
switch run_from_file
    ...
    case 0
        ...
        for i = 1:size(directories,1),
            ...
            %latest pre-process now makes this a variable under the
            %analyzed_xcorr_Vm.mat file ***
            ...
            resampled_theta_per_bar = theta_per_bar;
            [ON_ellipse_array,OFF_ellipse_array,singleunit_params,interunit_params] = ...
                mvn_density_multiellipse_updateM(resampled_kernel_50,...
