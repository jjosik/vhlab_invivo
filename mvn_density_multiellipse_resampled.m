function [ ON_ellipse_array,OFF_ellipse_array,...
    ...
    mvn_density_multiellipse_resampled( resampled_kernel,o_kernel,pixels_square,watch_fit,...
...
kernel_norm = rescale(resampled_kernel,scale.*[-1 1],[0 new_scalemax]);
o_kernel_norm = rescale(o_kernel,scale.*[-1 1],[0 new_scalemax]);
half_scale = new_scalemax/2;
